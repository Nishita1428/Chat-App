A real-time chat application built using MongoDB, Express.js, React.js, and Node.js (MERN). It supports user authentication, group chats, and real-time messaging.
